...
if (isset($_POST['reset_email'])) {
		...
		<a href="http://localhost:8888/tests/PlateFormTutorat 2/?controller=users&action=resetPassword"> reset password</a> Ce message  est généré automatiquement, veuillez ne pas répondre.';
		$message_html ='<html><head></head><body><p>Bonjour, </p><p> Mot de passe oublié.</p><p>Pour ce faire veuillez cliquez sur le lien juste en bas.Ce message est généré automatiquement.veuillez <b>ne pas répondre</b>,please  <b>do not answer</b></p>.<p><a href="http://localhost:8888/tests/PlateFormTutorat 2/?controller=users&action=resetPassword"> reset password</a></p></body></html>';
		//Sujet
