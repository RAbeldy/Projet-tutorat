                                        ...
                                        <div class="card debut">
                                            ...
                                            <div class="card-body row">
                                                <div class="col-md-5" style="text-align: center;">
                                                    <span style="color: black; font-style: oblique;">   Tuteur:  </span>
                                                    <span style="text-transform: capitalize;"><?= $data->getNom();?> <?= $data->getPrenom();?></span>
                                                    <div id="profilPic">
                                                        <img src='<?=$data->getChemin_photo() ;?>'>
                                                    </div>
                                                </div>
                                                <div class="table-responsive table col-md-7" role="grid" aria-describedby="dataTable_info">
                                                    <table class="table dataTable my-0" id="dataTable" style="margin-top: 13%!important;">
                                                        <thead>
                                                            <tr>
