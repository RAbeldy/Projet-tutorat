                                        ...
                                        <div class="col-xs-12 col-md-6 card-container">
                                            <div class="card avenir">
                                                <div class="card-body">
                                                    ...
                                                    {
                                                        ?>
                                                    <a href="?controller=tuteurs&action=tutores_list">
                                        ...
                                        <div class="col-xs-12 col-md-6 card-container">
                                            <div class="card historique">
                                                <div class="card-body">
                                                    ...
                                                    <a href="?controller=tuteurs&action=working_list">
                                                        <button class="btn" type="button">Je travaille<br/>avec eux</button>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
