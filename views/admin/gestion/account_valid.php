                                    ...
                                    <div class="row">
                                        <div class="card debut">
                                            <div class="card-header py-3">
                                                <p class="text-primary m-0 font-weight-bold">Statut des comptes</p>
                                                        ...
                                                        <tbody>
                                                             ...
                                                             foreach ($donnees as $elt) 
                                                            {
                                                             ?>
                                                              ...
                                                              <form method="post" action="?controller=admin&action=annul_account">
                                                              ...
                                                              <tr >
																  ...
																  <?php 
																	   ...
																	   if($elt['libelle']=="VALIDE")
																	   {
																		   
									                              ?>
                                                                     <td><button class="btn" type="submit"name="desactiver" >desactiver</button>
                                                                     </td>
																	  ...
																	  {
																	?>     
																	  <td><button class="btn" type="submit"name="activer" >activer</button>
                                                                     </td> 
																	<?php
																	  }
																	 ?>
