...
<div class="login-clean">
    <form method="post" onsubmit='javascript:validateForm();' action="createAccount.php">
     <div class="form-group" id="Yes" name="text1" style="display:block;">
                ...
                <div class="form-group">
                    <input class="form-control" type="number" minlength="10" id="c" maxlength="14" name="phone" id="b" placeholder="Téléphone"
                        >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <button class="btn-login btn-primary btn-block" type="submit"
