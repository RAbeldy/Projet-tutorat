<?php
  ...
  $controllers = array(
                       ...
                       'admin'=>['interface_admin','interface_admin_tuteur','admin_set_event','tuteurs_list','tutores_list','interface_tutores_mef','sign_up','choose_tuteur'],

                       'evenements' =>['set_event','cancel_participation','display_pasts_events','display_future_events','display_subscribed_events','subscribe_to_event','pasts_events','events_list','subscription_list']);
